/* ==========================================================================
   TOKEN SAYMA UTILITY'Sİ (TypeScript)
   ========================================================================== */
...
export function calculateTokenUsage(text: string, limit: number = 12000) {
...
export function calculateTotalTokenUsage(texts: string[], limit: number = 12000) {
